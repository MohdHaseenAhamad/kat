...
class CuttingControllter extends Controller {
    ...
    public function add() {
        return view('admin/cutting-report/form');
    }
    ...
    public function update(Request $request, $id) {
        ...
        $retval = DB::table('cutting')->where('cr_id', $id)->update($data);
        if ($retval > 0) {
    ...
    public function loadData($request, $mode) {
        ...
        $data = [
            ...
            'tilting_layer' => $request->tilting_damage,
    ...
    public function edit($id) {
        ...
        return view('admin/cutting-report/form')->with('results', $results);
    }
